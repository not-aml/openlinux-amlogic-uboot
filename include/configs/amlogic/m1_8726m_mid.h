...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"chipname=8726m\0" \
	"machid=2956\0" \
	"bootargs=init=/init console=ttyS0,115200 board_ver=v2 hdmitx=vdacoff,powermode1,unplug_powerdown rootwait logo=osd1,0x84100000,lcd,full\0" \
	"partnum=4\0" \
	"p0start=400000\0" \
	"p0size=400000\0" \
	"p0path=u-boot-env\0" \
	...
	"normalstart=1c00000\0" \
	"normalsize=1000000\0" \
	"recoverystart=c00000\0" \
	"recoverysize=1000000\0"
	
	
#define CONFIG_BOOTCOMMAND  "nand read 84100000 ${p1start} ${p1size};nand read ${loadaddr} ${normalstart} ${normalsize};bootm"
