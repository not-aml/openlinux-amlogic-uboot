...
*/
#define KEY_UP(value)      ((value >= 0)&&(value <= 0 + 60))?1:0
#define KEY_DOWN(value)    ((value >= (183 - 60))&&(value <= (183 + 60)))?1:0
#define KEY_ENTER(value)   ((value >= (408 - 60))&&(value <= (408 + 60)))?1:0
#define KEY_EXIT(value)    ((value >= (511 - 60))&&(value <= (511 + 60)))?1:0
//test menu item
#define ITEM_OPEN          1
#define ITEM_CLOSE         0
