...
#define MTDPARTS_DEFAULT	"mtdparts=nandflash1:256m@64m(system)\0"
#endif
...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"chipname=8726m\0" \
	"machid=2956\0" \
	"bootargs=init=/init console=ttyS1,115200 board_ver=v2 mem=256M hdmitx=vdacoff,powermode1,unplug_powerdown rootwait logo=osd1,0x84100000,lcd,full\0" \
...
#define CONFIG_BOOTCOMMAND  "nand read 84100000 ${p0start} ${p0size};nand read ${loadaddr} ${normalstart} ${normalsize};bootm"
#endif
