...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"nandboot=echo Booting from nand ...; " \
		...
		"bootm ${loadaddr}\0" \
		"boardname=BGA372-M_SKT_V1\0" \
		"chipname=8726m\0" \
		"machid=2956\0" \
    "bootargs=root=254:2 rw init=/init console=ttyS0,115200 rootdelay=5 a9_clock=600M clk81=187500k\0"

	
#define CONFIG_BOOTCOMMAND \
	"mmcinfo;fatload mmc 0 82000000 uImage;bootm" \
...
#define CONFIG_SYS_PROMPT		"BGA372-M_SKT_V1 # "
...
#define CONFIG_HARDWARE_FIN     2400000 // 24Mhz crystal .
/*-----------------------------------------------------------------------
 * Stack sizes
 *
