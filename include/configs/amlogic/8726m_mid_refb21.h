...
#define UBOOTPATH		"u-boot-aml-nova1.bin"
#else
...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"chipname=8726m\0" \
	"machid=2956\0" \
	"bootargs=init=/init console=ttyS1,115200 board_ver=v3 clk81=187500k "  BOARD_INFO_ENV  "hdmitx=vdacoff,powermode1,unplug_powerdown rootwait logo=osd1,0x84100000,lcd,full\0" \
	"mtdids=" MTDIDS_DEFAULT \
	"mtdparts="MTDPARTS_DEFAULT \
	"logo_start=0x1000000\0" \
	"logo_size=0x800000\0" \
	"aml_logo_start=0x1800000\0" \
	"aml_logo_size=0x800000\0" \
	"bootloader_start=0\0" \
	"bootloader_size=60000\0" \
	"bootloader_path=" UBOOTPATH "\0" \
	"normal_start=0x3000000\0" \
	"normal_size=1000000\0" \
	"recovery_start=0x2000000\0" \
	"recovery_size=1000000\0" \
...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"chipname=8726m\0" \
	"machid=2956\0" \
	"bootargs=init=/init console=ttyS1,115200 board_ver=v3 uboot_ver=v2 clk81=187500k"  BOARD_INFO_ENV  "hdmitx=vdacoff,powermode1,unplug_powerdown rootwait logo=osd1,0x84100000,lcd,full,loaded\0" \
	"partnum=4\0" \
	"p0start=0x3000000\0" \
	"p0size=0x800000\0" \
	"p0path=logo\0" \
