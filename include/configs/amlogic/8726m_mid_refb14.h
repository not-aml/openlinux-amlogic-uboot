...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"normal_size=0x400000\0" \
	"recovery_start=0x6800000\0" \
	"recovery_size=0x400000\0" \
...
#define CONFIG_BOOTCOMMAND  "nand read 84100000 ${p0start} ${p0size};nand read ${loadaddr} ${normal_start} ${normal_size};lcd bl off;bootm"
#endif
...
#define CONFIG_ETHADDR          	00:1A:95:00:00:01	/* Ethernet address */
#define CONFIG_IPADDR				10.68.11.211				/* Our ip address */
#define CONFIG_GATEWAYIP			10.68.11.1			/* Our getway ip address */
#define CONFIG_SERVERIP				10.68.11.60		/* Tftp server ip address */
