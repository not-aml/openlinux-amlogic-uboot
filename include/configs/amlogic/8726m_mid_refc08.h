...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"chipname=8726m\0" \
	"machid=2956\0" \
	"bootargs=root=/dev/mtdblock5 logo=osd1,0x84100000,full,720p,full init=/init console=ttyS0,115200 rootwait\0" \
	"partnum=4\0" \
	"p0start=0x2000000\0" \
	"p0size=0x800000\0" \
	"p0path=logo\0" \
	...
	"p3size=1000000\0" \
	"p3path=uImage\0" \
	"logo_start=0x800000\0" \
	"logo_size=0x800000\0" \
	"aml_logo_start=0x800000\0" \
...
#define CONFIG_BOOTCOMMAND  "nand read ${loadlogoaddr} ${aml_logo_start} ${aml_logo_size};nand read ${loadaddr} ${normal_start} ${normal_size};bootm 82000000;"
#endif
...
*/
#define KEY_UP(value)      ((value >= (306-60))&&(value <= 306 + 60))?1:0
#define KEY_DOWN(value)    ((value >= 0)&&(value <= (0 + 60)))?1:0
#define KEY_ENTER(value)   ((value >= (760 - 60))&&(value <= (760 + 60)))?1:0
#define KEY_EXIT(value)    ((value >= (602 - 60))&&(value <= (602 + 60)))?1:0
//test menu item
#define ITEM_OPEN          1
#define ITEM_CLOSE         0
...
#define CONFIG_TOUCHSCREEN_ADS7846
