 ...
 */
						/* Sector */
#define CONFIG_SYS_MALLOC_LEN		(CONFIG_ENV_SIZE + (1 << 25))
...
#else
	#define UBOOTPATH		"u-boot-aml-plnt1.bin"
#endif
...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"chipname=8726m\0" \
	"machid=2956\0" \
	"bootargs=init=/init console=ttyS1,115200 board_ver=v2 clk81=187500k mem=256M hdmitx=vdacoff,powermode1,unplug_powerdown rootwait logo=osd1,0x84100000,lcd,full\0" \
...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"chipname=8726m\0" \
	"machid=2956\0" \
	"bootargs=init=/init console=ttyS1,115200 board_ver=v2 uboot_ver=v2 clk81=187500k mem=256M hdmitx=vdacoff,powermode1,unplug_powerdown rootwait logo=osd1,0x84100000,lcd,full,loaded\0" \
	"partnum=4\0" \
	"p0start=0x3000000\0" \
	"p0size=0x800000\0" \
	"p0path=logo\0" \
