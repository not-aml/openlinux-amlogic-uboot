...
#define CONFIG_AMLROM_U_BOOT	   1    /**
								        ...
								        */
#define CONFIG_BOARD_MBOX_8626M1    1
...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"nandboot=echo Booting from nand ...; " \
		"run nandargs; " \
		"onenand read ${loadaddr} 600000 400000; " \
		"bootm ${loadaddr}\0" \
		"boardname=m1_dvbc_m1\0" \
		"chipname=8226m\0" \
		"machid=2955\0" \
		"bootargs=root=254:1 rw init=/linuxrc console=ttyS0,115200 rootfstype=ext2 clk81=187500k\0" \

	
#define CONFIG_BOOTCOMMAND \
	"mmcinfo 0;ext2load mmc 0 82000000 uImage;bootm" \
...
#define CONFIG_SYS_PROMPT		"SZ_MBX # "
