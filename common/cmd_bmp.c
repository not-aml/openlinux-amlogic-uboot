...
//support 24bits BMP only
static void * parse_bmp(int *w,int *h,void *addr)
{
#define INFO_OFFSET 18
#define DATA_OFFSET 0x36
       memcpy(w,addr+INFO_OFFSET,4);
       memcpy(h,addr+INFO_OFFSET+4,4);
       return addr+DATA_OFFSET;
}
