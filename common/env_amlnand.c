...
extern unsigned long USER_BYTES_3_0;
extern unsigned long USER_BYTES_3_0_bak;
...
int readenv (size_t offset, u_char * buf)
{
	...
	if(map_flag == 0) {
		for(i=0; i<CONFIG_ENV_BLOCK_NUM; i++){
			...
			env_map[i].env_valid = (USER_BYTES_3_0_bak == 0xaa55aa55 );
