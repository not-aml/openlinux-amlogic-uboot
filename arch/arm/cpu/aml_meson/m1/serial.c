...
static int serial_set_pin_port(int port)
{	
	//6236m
	//GPIOC_13//UART_TX_B // I2C_SCK_B
	//176 GPIOC_14//UART_RX_B // I2C_SDA_B
	//reg3-27.30
	int i;
...
//    if(port==UART_B)
//		SET_CBUS_REG_MASK(PERIPHS_PIN_MUX_3,((1 << 22) | (1 << 23)|(1 << 24)));
#else
	if(port==UART_B)
		SET_CBUS_REG_MASK(PERIPHS_PIN_MUX_3,((1 << 30) | (1 << 27)));
#endif
	//@todo add UART_A pinmux
	return 0;
}
