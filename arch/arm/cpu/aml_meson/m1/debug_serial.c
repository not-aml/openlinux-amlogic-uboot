...
#if (defined CONFIG_BOARD_MBOX_8626M1) || (defined CONFIG_BOARD_GADMEI_6236M)// || (defined CONFIG_BOARD_8726M_MID)
...
#elif defined CONFIG_BOARD_8726M_MID
	SET_CBUS_REG_MASK(PERIPHS_PIN_MUX_5,((1 << 23)|(1 << 24)));//UARTB
	//SET_CBUS_REG_MASK(PERIPHS_PIN_MUX_3,((1 << 23)|(1 << 24)));//UARTA
#else
