...
#define NFC_SEND_CMD_M2N(size,ecc,ecc_on)          NFC_SEND_CMD(M2N |(ecc<<14)|(ecc_on<<16)|(size&0x3fff))
#define NFC_SEND_CMD_N2M(size,ecc,ecc_on)          NFC_SEND_CMD(N2M |(ecc<<14)|(ecc_on<<16)|(size&0x3fff))
