 ...
 * author : jerry.yu
 */
#ifndef __MESON_UART_H_
#define __MESON_UART_H_
#include "am_regs.h"
#if CONFIG_AML_DEF_UART>1 || (!defined CONFIG_AML_DEF_UART) 
...
#define UART_B		1
    ...
    #define UART_BASE UART0_WFIFO
#elif CONFIG_AML_DEF_UART==1
    #define UART_BASE UART1_WFIFO
#else
#error Wrong CONFIG_AML_DEF_UART paramter
#endif
#endif
