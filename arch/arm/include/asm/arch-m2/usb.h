/*
 *  arch/arm/mach-meson/include/mach/usbclock.h
 *
...
#ifndef __ARCH_ARM_MESON_USB_H_U_BOOT_
#define __ARCH_ARM_MESON_USB_H_U_BOOT_
#include <common.h>
#include <asm/io.h>
#include <asm/types.h>
#include "am_regs.h"
...
/* M2 usb clock cfg
   ...
   cfg = 2 : other PLL
   cfg = 3 : DDR pll
   cfg = 4 : dmod pll out 3
   cfg = 5 : dmod pll out 1
   cfg = 6 : sys_pll_div3
   cfg = 7 : sys_pll_div4
  */
...
#define	USB_PHY_CLOCK_SEL_DEMOD_PLL_1 (5)
#define	USB_PHY_CLOCK_SEL_SYS_PLL_3	(6)
#define	USB_PHY_CLOCK_SEL_SYS_PLL_4	(7)
