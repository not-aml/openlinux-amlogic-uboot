 ...
 *
 *  Description: SD/SDHC/MMC card
 *
 *  Author:
 *  Created:
 *
 *  card data structure: lwords -- big endian; bytes in a lword -- little endian;
 *
 *******************************************************************/

#ifndef _ASM_ARC_CARD_SD_H
#define _ASM_ARC_CARD_SD_H
...
typedef struct aml_card_sd_info AML_CARD_SD_INFO_t ;
...
#define SDIO_PORT_MAX   4
#define SDIO_PORT_A    0
#define SDIO_PORT_B    1
#define SDIO_PORT_C    2
#define SDIO_PORT_XC   3
